...
public class Controller implements Initializable
{
	...
	public void initialize(URL location, ResourceBundle resources)
	{
		 ...
		 */
		ObjectProperty<TreeItem<Expression<Number>>> rootItemProperty = expressionsModel.rootItemProperty();
		expressionsTreeView.rootProperty().bind(rootItemProperty);
	...
	public void onDeleteSelectedAction(ActionEvent event)
	{
		...
		for (ExpressionDisplay<Number> expr : removable) {
			change = expressionsModel.remove(expr.getExpression()) || change;
		}
	...
	public void onDisplayButtonsWithStyle(ActionEvent event)
	{
		...
		if (event != null)
		{
			...
			if(source == graphicsOnlyRadiomenuItem){
				...
				message = "Display Buttons with Graphics only action triggered";
			} else if (source == textAndGraphicsRadiomenuItem) {
				contentDisplay = ContentDisplay.LEFT;
				message = "Display Buttons with Text and Graphics action triggered";
