...
public enum BinaryOperatorRules
{
	/**
	 * Any operator rule.
	 * Do not represent any operator but used for filtering purposes
	 */
	ANY,
	/**
	 ...
	 */
	public static List<BinaryOperatorRules> all()
	{
		List<BinaryOperatorRules> list = new ArrayList<>();
		for (BinaryOperatorRules op : values())
		{
			list.add(op);
		}
		return list;
